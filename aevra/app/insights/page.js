...
export const metadata = {
  title: "Insights",
  description:
    "Practical perspectives on AI strategy, software modernization, and enterprise technology from the Aevra team.",
};
      ...
      <section className="relative pb-28" aria-labelledby="insights-list-heading">
        <Container>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {insights.map((post) => (
              <article key={post.slug} className="group glass rounded-2xl p-7 flex flex-col hover:border-electric/40 transition">
