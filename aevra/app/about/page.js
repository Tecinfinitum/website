...
export const metadata = {
  title: "About",
  description:
    "Aevra is an enterprise software consulting and AI solutions partner focused on measurable business outcomes — operational efficiency, lower costs, and scalable systems.",
};
