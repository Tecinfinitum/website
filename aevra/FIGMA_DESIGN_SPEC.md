...
1. **Nav (sticky)** — glass pill, max-width 1200, 16px top margin. Logo (gradient `A` square + "Aevra") left; links Services / Work / Clients / Contact center; white "Book a call" pill right. Mobile: hamburger.
